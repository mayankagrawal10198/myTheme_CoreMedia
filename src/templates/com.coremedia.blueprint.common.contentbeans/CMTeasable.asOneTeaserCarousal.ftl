...
<div class="new-teaser-card-img-con">
  <a id="" title="${self.teaserTitle!self.title!""}" class="hp-hover-image-wrapper" href=targetLink target="_blank">
    <div>
        <@cm.include self=self.picture!cm.UNDEFINED view="media" />
    </div>
